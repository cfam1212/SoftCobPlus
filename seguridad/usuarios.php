        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    ...
                    <button type="button" class="btn btn-outline-success" id="btnNuevo" data-toggle="tooltip" data-placement="top" title="nuevo usuario" style="margin-bottom:10px"><i class="fa fa-plus"></i></button>
