        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="panel_content.php" class="site_title"> <span>SoftCob</span></a>
            </div>
                      ...
                      if($menurow['CodigoMenuPadre'] == null)
                      {
                        if($temmenuid != $menurow["MenuId"]){
                          ...
                          foreach($menu as $submenu){
                            ...
                            {
                                echo "<li><a href='" . "../views/" . $submenu["Programa"] . "'>" . $submenu["Tarea"] . "</a></li>";
                            }
                          }
                           echo "</ul></li>";
                           $temmenuid = $menurow["MenuId"];
                        }
                      }
                    }
