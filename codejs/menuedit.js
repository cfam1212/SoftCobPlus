$(document).ready(function(){
    ...
    $(document).on("click","#btnSubirNivel",function(e){     
        ...
        if(_row_index == 0)
        {
            ...
            mensajesalertify("No se puede Subir de Nivel..!","E","bottom-right",5);
            return;
        }
    ...
    $(document).on("click","#btnBajarNivel",function(e){     
        ...
        if(_row_index == _contar-1)
        {
            ...
            mensajesalertify("No se puede Bajar de Nivel..!","E","bottom-right",5);
            return;
        }
    ...
    function FunValidar(response){
        if(!response){
            ...
            mensajesalertify("Nombre del Menú ya Existe..!","E","bottom-right",5);
        }else{
            if(_opcionmp == 2){
                if(_menupadre == ''){
    ...
    function FunGrabar(response){
        if(!response){
            ...
            mensajesalertify("Nombre del Menú Padre ya Existe..!","E","bottom-right",5);    
        }else{
