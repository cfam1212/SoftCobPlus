$(document).ready(function(){
    ...
    var _estado, _result = [], _id, _count, _deshabilitar, _deshabilitae, _resultado = [];

    _estado = $("#lblEstadoCab").text();   
    _id = $("#paraid").text();
...
$('#btnSave').click(function(){
    ...
    $.ajax({
        ...
        type: "POST",
        dataType: "json",
        data: {nomparametro:_nomparametro, descripcion:_descripcion, result:_result, estado:'Activo', id:_id, opcion:1},            
